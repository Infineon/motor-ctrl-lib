...
/**
 * @file Params.c
 * @brief Motor control parameter initialization and lookup table generation
 *
 * Implements parameter management and trigonometric lookup table generation.
 */
...
/** @brief Build the trigonometric lookup tables (sin, atan, asin) used by the controller.
 *         Populates params_lut with TRIG_LUT_WIDTH sin samples over [0, PI/2] and
 *         INV_TRIG_LUT_WIDTH atan/asin samples over [0, 1], computed via sinf/atanf/asinf. */
