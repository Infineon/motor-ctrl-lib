 ...
 *
 * This module provides a flexible biquad filter that can be initialized using
 * pole/zero, continuous-time, or discrete-time coefficients.
 */
 ...
 * - n0 is always normalized to 1.0f
 */
typedef struct
{
    float fs;     /**< Sampling frequency [Hz] */
    float k;      /**< DC gain */
    float wz[2];  /**< Zero frequencies [rad/s] */
    float wp[2];  /**< Pole frequencies [rad/s] */
    float a[3];   /**< Continuous numerator coefficients */
    float b[3];   /**< Continuous denominator coefficients */
    float m[3];   /**< Discrete numerator coefficients */
    float n[3];   /**< Discrete denominator coefficients (n[0]=1.0f) */
    float d[3];   /**< State/delay variables */
