...
/**
 * @file PhaseAdvance.c
 * @brief Phase advance control implementation for IPM motors
 *
 * Implements MTPA control calculations for optimal current distribution.
 */
 ...
 *
 * Determines motor type (SPM or IPM) and calculates inductance ratios.
 *
 ...
 *
 * Calculates optimal qd-axis current references for MTPA operation.
 *
 * @param motor_ptr Pointer to motor control structure
 */
 ...
 *
 * Approximates optimal stator current for given qd currents. Avoids solving 4th order polynomial.
 *
 * @param motor_ptr Pointer to motor control structure
