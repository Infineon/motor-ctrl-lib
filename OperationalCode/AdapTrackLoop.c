...
/**
 * @file AdapTrackLoop.c
 * @brief Adaptive tracking loop implementation
 *
 * Implements an adaptive tracking loop for position estimation using feed-forward
 * and feedback control with adaptive gain adjustment.
 */
 ...
 *
 * Configures the feed-forward filter coefficient, feedback coefficient, and
 * bandwidth limits based on the provided parameters.
 *
 * @param atl_instance Pointer to adaptive tracking loop instance
 ...
 *
 * Initializes all state variables to zero or the specified initial angle.
 *
 * @param atl_instance Pointer to adaptive tracking loop instance
 ...
 * - Filters the feed-forward speed
 * - Calculates adaptive gain based on feed-forward speed
 * - Computes total speed (feed-forward + feedback correction)
 * - Updates estimated rotor angle
 *
 * @param atl_instance Pointer to adaptive tracking loop instance
 * @param sample_time Sampling time in seconds
 */
