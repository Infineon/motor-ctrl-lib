...
/**
 * @file FluxWeaken.c
 * @brief Flux weakening implementation for RFO and SFO
 *
 * Implements flux weakening to extend speed range:
 * - RFO: Uses integrator to generate negative D-axis current based on voltage limit
 * - SFO: Calculates flux command limit based on voltage and speed
 * Both methods monitor voltage limits to activate/deactivate weakening.
 */
...
/**
 * @brief Reset flux weakening (RFO)
 *
 ...
 *
 * Executes flux weakening algorithm:
 * - Calculates available Q-axis voltage based on DC bus and D-axis voltage
 * - RFO: Integrates voltage error to generate D-axis weakening current
 * - SFO: Calculates flux limit based on voltage and speed
 * - Sets activation flag and applies limits
 *
 * @param motor_ptr Pointer to motor structure
 */
RAMFUNC_BEGIN
