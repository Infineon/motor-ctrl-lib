...
/**
 * @file FluxCtrl.c
 * @brief Flux controller implementation for SFO
 *
 * Implements D-axis flux control by regulating the stator flux linkage magnitude
 * to its commanded value. Uses PI control to generate D-axis voltage command.
 */
...
/**
 * @brief Initialize flux controller
 *
 * Configures the PI controller with bandwidth reduction for flux control.
 *
 * @param motor_ptr Pointer to motor structure
 * @param bw_red_ratio Bandwidth reduction ratio (squared for integral gain)
 */
...
/**
 * @brief Reset flux controller
 *
 * Resets the PI controller state to zero.
 *
 * @param motor_ptr Pointer to motor structure
 */
...
/**
 * @brief Run flux controller (ISR0)
 *
 * Executes flux PI control to regulate D-axis flux linkage.
 * Generates D-axis voltage command in stator flux frame.
 *
 * @param motor_ptr Pointer to motor structure
 */
RAMFUNC_BEGIN
